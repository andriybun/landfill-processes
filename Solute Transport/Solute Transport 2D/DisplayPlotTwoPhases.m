function DisplayPlotTwoPhases(timeOutVec, ...
                              cMobOutArr, ...
                              cImmobOutArr, ...
                              ModelDim, ...
                              SoilPar, ...
    ...
    soluteIdx = 1;
    plot(timeOutVec, squeeze(cImmobOutArr(selectedNodes, soluteIdx, :)), 'LineWidth', 2);
    
    % Plot numerical solution
    hold on
    plot(timeOutVec, squeeze(cMobOutArr(selectedNodes, soluteIdx, :)), 'o-', 'LineWidth', 1);
    hold off
