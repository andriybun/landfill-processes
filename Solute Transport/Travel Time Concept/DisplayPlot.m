function DisplayPlot(timeOutVec, ...
                        cOutArr, ...
                        cAnalyticalArr, ...
                        ModelDim, ...
                        d, ...
    ...
    hold on
    plot(timeOutVec, squeeze(cOutArr(selectedNodes, :)), 'o-', 'LineWidth', 1);
    hold off
    ...
    title(sprintf('Concentrations at depths (v = %5.3e, d = %5.3e)', inFlow, d(1)), 'FontWeight','bold');
