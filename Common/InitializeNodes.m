function ModelDim = InitializeNodes(varName, varTop, varBottom, dVar)
%
...
%
    ...
    ModelDim.(vn) = nan(ModelDim.(vnn), 1);
    ModelDim.(vn)(1:ModelDim.(vnn)) = ...
        (ModelDim.(vin)(1:ModelDim.(vnin)-1) + ModelDim.(vin)(2:ModelDim.(vnin))) ./ 2;
